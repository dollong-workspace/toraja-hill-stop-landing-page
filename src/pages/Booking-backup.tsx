...
const ROOMS = [
  {
    ...
    description:
      "Experience the breathtaking beauty of Toraja from our Deluxe Mountain View room. This spacious unit features floor-to-ceiling windows, a private balcony for morning coffee, and a modern en-suite bathroom with hot water rain shower.",
  ...
  },
  {
    ...
    description:
      "A peaceful sanctuary overlooking our lush tropical garden. Wake up to birdsong and enjoy the serene atmosphere of traditional Torajan hospitality with modern comfort.",
  ...
  },
  {
    ...
    description:
      "Our signature room featuring authentic Torajan wood carvings and textiles. Experience the rich cultural heritage while enjoying premium amenities and stunning highland views.",
    amenities: ["2 Guests", "King Bed", "Fast WiFi", "Breakfast"],
    image: bedroomImg,
  },
  {
    ...
    description:
      "Perfect for solo travelers or couples seeking an intimate escape. This charming room offers all essential comforts with a warm, welcoming ambiance.",
...
const Booking = () => {
  ...
  const totalPrice = selectedRoom
    ? selectedRoom.price_per_night * (nights || 0)
    : 0;
          ...
          <div className="container mx-auto px-4 py-8 lg:py-16">
            ...
            <div className="mb-8">
              ...
              <p className="text-muted-foreground font-body mt-2 max-w-xl">
                Select your preferred room to view details and check
                availability for your retreat in the highlands.
              </p>
            </div>
